extends "res://Characters/TemplateCharater.gd"
...
func Player_in_LOS():
	...
	var LOC_obstacle = space.intersect_ray(global_position, Player.global_position, [self], collision_mask)
	...
	if LOC_obstacle.collider == Player and Player_in_range:
		return true
	else:
		return false
